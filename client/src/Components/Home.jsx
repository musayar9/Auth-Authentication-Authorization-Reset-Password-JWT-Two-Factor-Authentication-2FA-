      ...
      <div className="flex flex-col items-center gap-4">
        <div className="space-y-2">
          ...
          <p className="text-md indent-4 text-zinc-600  font-semibold">
            ...
            being maintained with its built-in identity. Additionally, through a
            number of applications, OTP includes two-factor authentication that
            can be accessed by a smart card or devices that a person may have,
          ...
          <p className="text-md indent-4 text-zinc-600  font-semibold">
            ...
            evidence method: knowledge is something that one knows only that one
            has learned, ownership is something that the student has and only
            the student, and inheritance It is something that the student and
            only the student is involved in. Two-factor identification A variant
            of multiple authentication, also known as 2FA or its subgroup. Users
            can use their identities in two different It is the validation
            ...
            {show && (
              <div className="space-y-3">
                ...
                <p className="text-slate-600 font-semibold">
                  ...
                  that are permitted with that token. Single Sign On is a
                ...
                <p className="text-zinc-600 font-semibold">
                  ...
                  signature is calculated using the header and the payload, you
                  can also verify that the content hasnt been tampered with.
                </p>
              </div>
            )}
          </div>
